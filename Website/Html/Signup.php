<?php include '../../Includes/AltHeader.php'; ?>
    ...
    <div class="login container">
        <div class="login-container">
           ...
           <p>Already have account?<a href="/Project/Website/Html/Login.php">Log In</a></p>
           ...
           <form action="">
            ...
            <a href="/Project/Website/Html/Login.php">Already have account</a>
           </form>
           <a href="/Project/Website/Html/Login.php" class="btn">Log In</a>
        </div>

        <div class="login-image">
            <img src="/Project/Website/Assets/SignupSticker.png" alt="">
        </div>
    </div>
